...
def get_distance_mask(L):
    ...
    m=np.zeros((3,L,L))
    # Inverse (0,L,L), Inverse squared (1,L,L), Inverse cubed (2,L,L) pairwise distance matrices
...
# Not Utilized! See weighted_MCRMSE(...)
...
def get_train_val_indices(df,fold,SEED=2020,nfolds=5):
    ...
    train_indices=splits[fold][0] # [10 folds and choose only one][0 is training split]
    val_indices=splits[fold][1] # [10 folds and choose only one][1 is validation split]
